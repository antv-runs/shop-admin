...
<div class="p-6">
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-4 max-w-lg">
        @csrf
        <div>
        ...
        <div>
            ...
            <textarea name="description" class="mt-1 block w-full border-gray-300 rounded">{{ old('description') }}</textarea>
        </div>
