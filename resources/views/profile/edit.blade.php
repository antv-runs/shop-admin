                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex items-start space-x-6">
                                <div class="w-24 h-24">
                                    @if($user->profile_image)
                                        <img src="{{ Storage::url($user->profile_image) }}" alt="{{ $user->name }}" id="preview" class="w-full h-full rounded-full object-cover border-4 border-blue-500">
                                    @else
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="{{ route('profile.show') }}" class="px-6 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 transition">
                                Cancel
                            </a>
                        </div>
                    </form>
